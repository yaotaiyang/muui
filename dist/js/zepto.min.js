...
/**Zepto data.js**/
(function(d){function l(a,b){var c=a[f],c=c&&g[c];if(void 0===b)return c||k(a);if(c){if(b in c)return c[b];var e=h(b);if(e in c)return c[e]}return m.call(d(a),b)}function k(a,b,c){var e=a[f]||(a[f]=++d.uuid);a=g[e]||(g[e]=n(a));void 0!==b&&(a[h(b)]=c);return a}function n(a){var b={};d.each(a.attributes||p,function(a,e){0==e.name.indexOf("data-")&&(b[h(e.name.replace("data-",""))]=d.zepto.deserializeValue(e.value))});return b}var g={},m=d.fn.data,h=d.camelCase,f=d.expando="Zepto"+ +new Date,p=[];d.fn.data= function(a,b){return void 0===b?d.isPlainObject(a)?this.each(function(c,b){d.each(a,function(a,c){k(b,a,c)})}):0 in this?l(this[0],a):void 0:this.each(function(){k(this,a,b)})};d.data=function(a,b,c){return d(a).data(b,c)};d.hasData=function(a){return(a=(a=a[f])&&g[a])?!d.isEmptyObject(a):!1};d.fn.removeData=function(a){"string"==typeof a&&(a=a.split(/\s+/));return this.each(function(){var b=this[f],c=b&&g[b];c&&d.each(a||c,function(b){delete c[a?h(this):b]})})};["remove","empty"].forEach(function(a){var b= d.fn[a];d.fn[a]=function(){var c=this.find("*");"remove"===a&&(c=c.add(this));c.removeData();return b.call(this)}})})(Zepto);
/**Zepto touch.js**/
